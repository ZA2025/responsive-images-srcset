...
const albums = [
    ...
    responsiveImgAttrs2(
        springArray.map(src => `placeholders/${src}`),
        "(min-width: 1600px) 285px, (min-width: 1200px) calc((1200px - 40px) / 2), (min-width: 768px) calc(((768px - 40px) - 20px) / 2), calc(((100vw - 40px) - 20px) / 2)",
        [600, 800, 1200, 1600],
        800,
        "imageSpring",
        "the alt description",
    ...
    responsiveImgAttrs2(
        springArray.map(src => `placeholders/${src}`),
        "(min-width: 1600px) 386px, (min-width: 1200px) calc((1200px - 40px) / 3), (min-width: 768px) calc(((768px - 40px) - 40px) / 3), calc(100vw - 40px)",
        [600, 800, 1200, 1600],
        800,
        "imageSpring",
        "the alt description",
